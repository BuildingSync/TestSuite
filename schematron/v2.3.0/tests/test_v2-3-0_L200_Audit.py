...
from schematron.conftest import AssertFailureRolesMixin, v2_3_0_SCH_DIR, exemplary_tree, replace_element, remove_element
...
class TestL200AuditMiscellaneous(AssertFailureRolesMixin):
    schematron = os.path.join(v2_3_0_SCH_DIR, 'v2-3-0_L200_Audit.sch')
    exemplary_file = os.path.join(v2_3_0_SCH_DIR, 'exemplary_files', 'L200_Audit.xml')
    ...
    def test_is_invalid_when_schedule_types_differ_inside_schedule_details(self):
        # -- Setup
        tree = exemplary_tree('L200_Audit', 'v2.3.0')
