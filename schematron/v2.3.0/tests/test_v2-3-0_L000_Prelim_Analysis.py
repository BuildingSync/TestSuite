...
class TestL000PrelimAnalysis(AssertFailureRolesMixin):
    schematron = os.path.join(v2_3_0_SCH_DIR, 'v2-3-0_L000_Prelim_Analysis.sch')
    exemplary_file = os.path.join(v2_3_0_SCH_DIR, 'exemplary_files', 'L000_Prelim_Analysis.xml')
    ...
    def test_fails_when_measured_scenario_missing(self):
        # -- Setup
        tree = exemplary_tree('L000_Prelim_Analysis', 'v2.3.0')
