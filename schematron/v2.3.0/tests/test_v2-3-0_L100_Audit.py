...
from schematron.conftest import AssertFailureRolesMixin, exemplary_tree, remove_element, replace_element, v2_3_0_SCH_DIR


class TestL100Audit(AssertFailureRolesMixin):
    schematron = os.path.join(v2_3_0_SCH_DIR, 'v2-3-0_L100_Audit.sch')
    exemplary_file = os.path.join(v2_3_0_SCH_DIR, 'exemplary_files', 'L100_Audit.xml')
    ...
    def test_is_valid_when_only_resource_use_is_electricity(self):
        # -- Setup
        tree = exemplary_tree('L100_Audit', 'v2.3.0')
